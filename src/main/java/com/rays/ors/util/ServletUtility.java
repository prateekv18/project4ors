...
public class ServletUtility {
	...
	/*    *//**
			 ...
			 *             the servlet exception
			 *//*
				 * public static void forwardView(String page,
				 * HttpServletRequest request, HttpServletResponse response)
				 * throws IOException, ServletException {
				 * 
				 * request.setAttribute("bodyPage", page); RequestDispatcher rd
				 * = request .getRequestDispatcher(ORSView.LAYOUT_VIEW);
				 * rd.forward(request, response); }
				 */
	...
	/*    *//**
			 ...
			 *//*
				 * public static String getErrorMessageHtml(HttpServletRequest
				 * request) {
				 * 
				 * Enumeration<String> e = request.getAttributeNames();
				 * 
				 * StringBuffer sb = new StringBuffer("<UL>"); String name =
				 * null;
				 * 
	 ...
	 * @return
	 *//*
		 * public static String getMessage(String property, HttpServletRequest
		 * request) { String val = (String) request.getAttribute(property); if
		 * (val == null) { return ""; } else { return val; } }
		 */
	 ...
	 * = (UserModel) request.getSession().getAttribute("user"); if (model !=
	 * null) { return model.getRoleId(); } else { return AppRole.STUDENT; } }
	 */
	/*    *//**
