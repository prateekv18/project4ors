...
public class UserModel {
	...
	public long add(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			System.out.println(pk + " in ModelJDBC" + bean.getDob());
	...
	//	log.debug("Model update Started");
		...
		try {
			...
			PreparedStatement pstmt = conn
					.prepareStatement("UPDATE ST_USER SET LOGIN_ID=?, PASSWORD=?, MOBILE_NO=?, ROLE_ID=?, CREATED_BY=?, MODIFIED_BY=?, CREATED_DATETIME=?, MODIFIED_DATETIME=? WHERE ID=?");
	...
	public long registerUser(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		/*
		 * HashMap<String, String> map = new HashMap<String, String>();
		 * map.put("Login: ", bean.getLogin()); map.put("Password: ",
		 * bean.getPassword());
		 * 
		 ...
		 * msg.setSubject("Registration is successful for ORS Project 4");
