...
public class MarksheetModel {
	...
	public long add(MarksheetBean bean) throws ApplicationException, DuplicateRecordException {
		...
		// get Student Name
		/*
		 * StudentModel sModel = new StudentModel(); StudentBean studentbean =
		 * sModel.findByPK(bean.getStudentId());
	...
	public MarksheetBean findByRollNo(String rollNo) throws ApplicationException {
		...
		try {
			...
			e.printStackTrace();
			// log.error(e);
			// throw new ApplicationException("Exception in getting marksheet by
			// roll no");
		} finally {
			JDBCDataSrc.closeConnection(conn);
		}
	...
	public void update(MarksheetBean bean) throws ApplicationException, DuplicateRecordException {
		 ...
		 * new DuplicateRecordException("Roll No is already exist"); }
		 */
