			...
			<table>
				<tr>
					...
					<td><input type="password" name="oldPassword"
						...
						value=<%=DataUtility.getString(request.getParameter("oldPassword"))%>>
					</td>
				...
				<tr>
					...
					<td><input type="password" name="newPassword"
						...
						value=<%=DataUtility.getString(request.getParameter("newPassword"))%>>
					</td>
				...
				<tr>
					...
					<td><input type="password" name="confirmPassword"
						...
						value=<%=DataUtility.getString(request.getParameter("confirmPassword"))%>>
					</td>
